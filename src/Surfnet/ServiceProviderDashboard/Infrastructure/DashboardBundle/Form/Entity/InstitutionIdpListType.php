...
class InstitutionIdpListType extends AbstractType
{

    public function __construct(
        public readonly IdpServiceInterface $idpService
    ) {
    }

    public function configureOptions(OptionsResolver $resolver): void
    {
        $list = $this->idpService->createCollection()->institutionEntities();
