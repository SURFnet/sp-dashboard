...
class ContractualBaseService
{
    public function writeContractualBase(ManageEntity $entity): void
    {
        ...
        switch ($serviceType) {
            case Constants::SERVICE_TYPE_INSTITUTE:
                $contractualBase = Constants::CONTRACTUAL_BASE_IX;
                break;
            case Constants::SERVICE_TYPE_NON_INSTITUTE:
                $contractualBase = Constants::CONTRACTUAL_BASE_AO;
                break;
            default:
                return;
        }
