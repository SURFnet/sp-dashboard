...
describe('validate visibility toggling of service status fields on the service edit form', function() {
    ...
    let editFormHtml = require('fs').readFileSync('./assets/js/components/mock/service_edit_form.html').toString();
...
describe('validate visibility toggling of service status fields on the service create form', function() {
    ...
    let createFormHtml = require('fs').readFileSync('./assets/js/components/mock/service_create_form.html').toString();
