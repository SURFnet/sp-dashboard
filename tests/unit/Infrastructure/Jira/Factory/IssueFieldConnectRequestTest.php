...
class IssueFieldConnectionRequestTest extends TestCase
{
    ...
    public function test_build_issue_field_from_connection_requests_ticket()
    {
        ...
        $this->translator
            ...
            ->andReturn('Body 1fst connection request - ')
            ->once();
        ...
        $this->translator
            ...
            ->andReturn('Body 2nd connection request')
            ->once();
        ...
        $this->assertEquals('Body 1fst connection request - Body 2nd connection request', $issueField->description);
