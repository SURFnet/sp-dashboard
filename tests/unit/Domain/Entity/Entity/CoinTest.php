...
class CoinTest extends TestCase
{
    ...
    {
        yield [
            new Coin('signatureMethod', '23', 'https://www.example.com', '1', 'https://example.com', new TypeOfServiceCollection(), 'https://example.com/eula', 1, true),
            new Coin('signatureMethod', '23', 'https://www.example.com', '1', 'https://example.com', new TypeOfServiceCollection(), 'https://example.com/eula', 1, true),
            new Coin('signatureMethod', '23', 'https://www.example.com', '1', 'https://example.com', new TypeOfServiceCollection(), 'https://example.com/eula', 1, true)
        ];
        yield [
        ...
        yield [
            new Coin('signatureMethod', '23', 'https://www.example.com', '1', 'https://example.com', new TypeOfServiceCollection(), 'https://example.com/eula', 1, false),
            new Coin(null, null, null, null, null, new TypeOfServiceCollection(), null, null, false),
            new Coin(null, null, null, '1', null, new TypeOfServiceCollection(), null, null, false)
        ];
    }
